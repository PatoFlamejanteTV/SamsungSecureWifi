QCOM_PRODUCT_DEVICE := beyond2qlteue

$(call inherit-product, device/samsung/beyond2qlteue/device.mk)
include vendor/samsung/configs/beyond2qlte_common/beyond2qlte_common.mk

# FactoryBinary doesn't need gms packages.
ifneq ($(SEC_FACTORY_BUILD),true)
# Include gms packages depending on product seperately
include vendor/samsung/configs/beyond2qlteue/gms_beyond2qlteue.mk
endif

PRODUCT_NAME := beyond2qlteue
PRODUCT_DEVICE := $(QCOM_PRODUCT_DEVICE)
PRODUCT_MODEL := SM-G975U1
...
include vendor/samsung/configs/beyond2qlteue/beyond2qlteue_vzwspr_apps.mk
include vendor/samsung/configs/beyond2qlteue/beyond2qlteuespr_apps.mk
