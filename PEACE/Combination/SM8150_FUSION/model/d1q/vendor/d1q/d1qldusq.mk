QCOM_PRODUCT_DEVICE := d1q

$(call inherit-product, device/samsung/d1q/device.mk)
include vendor/samsung/configs/d1q_common/d1q_common.mk

# FactoryBinary doesn't need gms packages.
ifneq ($(SEC_FACTORY_BUILD),true)
# Include gms packages depending on product seperately
include vendor/samsung/configs/d1q/gms_d1qldusq.mk
endif


PRODUCT_NAME := d1qldusq
PRODUCT_DEVICE := $(QCOM_PRODUCT_DEVICE)
PRODUCT_MODEL := SM-N970XU
