QCOM_PRODUCT_DEVICE := beyond0qltecmcc

$(call inherit-product, device/samsung/beyond0qltecmcc/device.mk)
include vendor/samsung/configs/beyond0qlte_common/beyond0qlte_common.mk

# FactoryBinary doesn't need gms packages.
ifneq ($(SEC_FACTORY_BUILD),true)
# Include gms packages depending on product seperately
include vendor/samsung/configs/beyond0qltecmcc/gms_beyond0qltezm.mk
endif
...
PRODUCT_NAME := beyond0qltezm
PRODUCT_DEVICE := $(QCOM_PRODUCT_DEVICE)
PRODUCT_MODEL := SM-G9708
ifeq ($(shell secgetspf SEC_PRODUCT_FEATURE_COMMON_FAKE_BINARY), TRUE)
PRODUCT_MODEL := SM-GA9200
endif
