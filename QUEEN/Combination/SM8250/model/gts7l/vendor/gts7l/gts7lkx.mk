QCOM_PRODUCT_DEVICE := gts7l

$(call inherit-product, device/samsung/gts7l/device.mk)
include vendor/samsung/configs/gts7l_common/gts7l_common.mk

# FactoryBinary doesn't need gms packages.
ifneq ($(SEC_FACTORY_BUILD),true)
include vendor/samsung/configs/gts7l/gms_gts7lkx.mk
endif

PRODUCT_NAME := gts7lkx
PRODUCT_DEVICE := $(QCOM_PRODUCT_DEVICE)
PRODUCT_MODEL := SM-T875N
