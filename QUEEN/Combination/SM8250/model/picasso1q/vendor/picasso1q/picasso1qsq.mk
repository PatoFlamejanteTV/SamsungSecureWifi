QCOM_PRODUCT_DEVICE := picasso1q

$(call inherit-product, device/samsung/picasso1q/device.mk)
include vendor/samsung/configs/picasso1q_common/picasso1q_common.mk

# FactoryBinary doesn't need gms packages.
ifneq ($(SEC_FACTORY_BUILD),true)
include vendor/samsung/configs/picasso1q/gms_picasso1qsq.mk
endif

PRODUCT_NAME := picasso1qsq
PRODUCT_DEVICE := $(QCOM_PRODUCT_DEVICE)
PRODUCT_MODEL := SM-G981U
