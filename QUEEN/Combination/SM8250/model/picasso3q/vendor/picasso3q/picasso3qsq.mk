QCOM_PRODUCT_DEVICE := picasso3q

$(call inherit-product, device/samsung/picasso3q/device.mk)
include vendor/samsung/configs/picasso3q_common/picasso3q_common.mk

# FactoryBinary doesn't need gms packages.
ifneq ($(SEC_FACTORY_BUILD),true)
include vendor/samsung/configs/picasso3q/gms_picasso3qsq.mk
endif

PRODUCT_NAME := picasso3qsq
