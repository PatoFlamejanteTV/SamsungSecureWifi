QCOM_PRODUCT_DEVICE := star2qltecs

$(call inherit-product, device/samsung/star2qltecs/device.mk)
include vendor/samsung/configs/star2qlte_common/star2qlte_common.mk

# FactoryBinary doesn't need gms packages.
ifneq ($(SEC_FACTORY_BUILD),true)
# Include gms packages depending on product seperately
include vendor/samsung/configs/star2qltecs/gms_star2qltecs.mk
endif


PRODUCT_NAME := star2qltecs
PRODUCT_DEVICE := $(QCOM_PRODUCT_DEVICE)
PRODUCT_MODEL := SM-G965W
