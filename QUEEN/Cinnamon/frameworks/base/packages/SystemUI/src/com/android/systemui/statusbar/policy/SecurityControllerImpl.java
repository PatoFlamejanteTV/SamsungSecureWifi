...
public class SecurityControllerImpl extends CurrentUserTracker implements SecurityController {
    ...
    // getCurrentVpnPackageName() method used to know the packagename of vpn currently connected
    @Override
    public String getCurrentVpnPackageName() {
        VpnConfig cfg = mCurrentVpns.get(mVpnUserId);
        if(cfg != null && cfg.user != null) {
            return cfg.user;
        }
        return null;
    }
