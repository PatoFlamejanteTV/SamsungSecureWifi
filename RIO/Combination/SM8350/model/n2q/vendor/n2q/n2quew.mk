QCOM_PRODUCT_DEVICE := n2q

$(call inherit-product, device/samsung/n2q/device.mk)
include vendor/samsung/configs/n2q_common/n2q_common.mk

# FactoryBinary doesn't need gms packages.
ifneq ($(SEC_FACTORY_BUILD),true)
include vendor/samsung/configs/n2q/gms_n2quew.mk
endif

PRODUCT_NAME := n2quew
PRODUCT_DEVICE := $(QCOM_PRODUCT_DEVICE)
PRODUCT_MODEL := SM-G996U1
