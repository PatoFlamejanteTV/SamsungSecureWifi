...
/**
 * Debug level, NAT-keepalive interval, retransmission policies
 */
#define ANDROID_DEBUG_LEVEL 1
#define ANDROID_KEEPALIVE_INTERVAL 45
#define ANDROID_RETRASNMIT_TRIES 6
#define ANDROID_RETRANSMIT_TIMEOUT 10
#define ANDROID_RETRANSMIT_BASE 1
#define ANDROID_INITIAL_RETRASNMIT_TRIES 3
#define ANDROID_INITIAL_RETRANSMIT_TIMEOUT 2.0
#define ANDROID_INITIAL_RETRANSMIT_BASE 1.4
...
struct charonservice_t {
	...
	/**
	 * Update the traffic in the Java domain (UI)
	 *
	 * @param notify_type   notify type
     * @param traffic_usage traffic usage (bytes)
     * @param traffic_limit traffic limit (bytes)
	 * @return				TRUE on success
	 */
	bool (*update_traffic)(charonservice_t *this, int notify_type, uint64_t traffic_usage, uint64_t traffic_limit);
